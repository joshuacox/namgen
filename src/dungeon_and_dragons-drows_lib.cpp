 ...
 *
 * The arrays are taken directly from `fantasy-names/generators/dungeon_and_dragons/drows.js`.
 * The logic follows the same branching based on a random `i` in [0,9] and the
 * optional `type` argument (type == 1 selects the “female” variant).
 */
std::string generate_dungeon_and_dragons_drows_name(std::mt19937& rng, int type) {
    static const std::vector<std::string> namesFem = {
    ...
    static const std::vector<std::string> namesFemRf = {
        "Akor","Alaun","Aly","Ang","Ardul","Aun","Bae","Bal","Belar","Briz","Bur","Chal","Char","Chess","Dhaun","Dil","Dirz","Dris","Eclav","Elvan","Elv","Erel","Ethe","Faer","Felyn","Filf","Gauss","G'eld","Ghuan","Gin","Grey","Hael","Hal","Houn","Iiv","Iim","Illiam","In","Ilph","Irae","In","Iym","Jan","Jhael","Jhul","Jys","Lael","Lar","LiNeer","Lird","Lua","Mal","May","Micar","Min","Mol","Myr","Nath","Ned","Nhil","Neer","Null","Olor","Pellan","Phaer","Phyr","Qualn","Quar","Quav","Qil","Rauv","Ril","Sbat","Sab","Shi'n","Shri","Shur","Shynt","Sin","Ssap","Susp","Talab","Tal","Triel","T'riss","Ulvir","Umrae","Vas","Vic","Vier","Vlon","Waer","Wuyon","Xull","Xun","Yas","Zar","Zebey","Zes","Zil"
    };
    static const std::vector<std::string> namesFemRl = {
        "a","ace","ae","aer","afae","afay","ala","anna","arra","aste","avin","ayne","baste","breena","bryn","cice","cyrl","da","dia","diira","dra","driira","dril","e","eari","eyl","ffyn","fryn","iara","ice","idil","iira","inidia","inil","intra","isstra","ithra","jra","jss","kacha","kiira","lay","lara","lin","lochar","mice","mur'ss","na","nilee","niss","nitra","nolu","olin","onia","oyss","qualyn","quarra","quiri","ra","rae","raema","raena","riia","ril","riina","ryna","ryne","shalee","ssysn","stin","stra","tana","thara","thrae","tree","tyrr","ual","ue","uit","une","uque","urra","va","vayas","vyll","vyrae","wae","wiira","wyss","xae","xena","xyra","yl","ylene","ymma","ynda","ynrae","vrae","yrr","zyne"
    };
    static const std::vector<std::string> namesFemFf = {
        "Ahly","Akor","Alau","Aly","Ama","Anga","Anlu","Ardu","Aun","Ba","Bal","Bau","Belar","Bes","Bri","Brigan","Bror","Bur","Byr","Caz","Cha","Chad","Chali","Chan","Char","Chari","Chen","Ches","Dhau","Dilyn","Dra","Dri","Eclav","Eler","Elv","Elvan","Era","Erel","Fae","Felyn","Fil","G'el","Gaus","Ghi","Gre","Gu","Hael","Halis","Ilha","Ilivar","Ilm","Im","Jael","Jez","Jha","Jhael","Jhan","Jhu","Kha","Kia","La","Lae","Lle","Llol","Lua","Ly","Ma","Menzo","Mez'Bar","Micar","Miz","Miz'","Myrym","Na","Narce","Nedy","Nen","Ni","Nul","Olo","Pella","Phae","Phyr","Qi","Quar","Rau","Ril","Sab","Sara","Sas","Sche","Shi","Shulvall","Shur","Shyn","Sindyr","Solen","Ssap","T'ris","Ta","Tala","Tall","Thal","Thir","Thrae","Uli","Ulvii","Um","Url","Urme","Vhon","Vico","Vier","Vor","Waer","Wuyon","Xa","Xu","Xull","Yas","Yvon","Z'res","Zar","Zebe","Zee","Zel","Zenda","Zes","Zil"
    };
    static const std::vector<std::string> namesFemFl = {
    ...
    static const std::vector<std::string> namesSur = {
    ...
    static const std::vector<std::string> namesSurRf = {
        "Alean","Ale","Arab","Arken","Auvry","Baen","Barri","Cladd","Desp","De","Do'","Eils","Everh","Fre","Gode","Helvi","Hla","Hun'","Ken","Kil","Mae","Mel","My","Noqu","Orly","Ouss","Rilyn","Teken'","Tor","Zau"
    };
    static const std::vector<std::string> namesSurRl = {
        "afin","ana","ani","ar","arn","ate","ath","duis","ervs","ep","ett","ghym","iryn","lyl","mtor","ndar","neld","rae","rahel","rret","sek","th","tlar","t'tar","tyl","und","urden","val","viir","zynge"
    };
    static const std::vector<std::string> namesSurFf = {
        "A'Dar","Ab","Abb","Arg","Baenre","Belt","Blaer","Blund","Chaulss","Cob","Col","Cormr","D","Daev","Dal","Dhalm","Dhunn","Dil","Din","Dryaal","Duskr","Elpr","Faert","Fil","Gall","Glann","Glaur","H","Helv","Hunzr","Hyl","Ich","Ilal","Ill","Jhal","Juszt","Keteer","Khal","Kront't","Lhal","Luelt","Mizzr","Mlezz","N","Nir","Ol","Omr","Phil","Quav","Rhomd","Rrost","Seer","Ss","T","T'","T'","Tanor'Th","Tel","Tlin'","Tlint","Ul","Vr","Vramm","Waegl","Xilt","Yaunt","Yril'Lys","Zaphr","Zauv","Zol"
    };
    static const std::vector<std::string> namesSurFl = {
        "abar","abban","ach","aeir","ael","aen","aer","aerth","agh","agon","al","ala","ambra","ane","ar","arn","arr","arran","aryd","ass","ath","aulur","avar","azza","ear","ein","enna","esz","eztice","ifar","iir","iirn","iiryn","in","inath","inn","iom","ion'lyr","iriy","is","istyn","ith","iwin","oara","oavae","ond","onrae","orel","orgh","oryn","orzza","ossz","uae","uan","uil","uin","une","ykur","yl","ylan","ym","yn","yr","yrr","yth"
    };

    // Random i in [0,9]
    int i = static_cast<int>(rng() % 10);

    if (type == 1) { // female variant
        if (i < 4) {
            size_t rnd = rng() % namesFemRf.size();
            size_t rnd2 = rng() % namesFemRl.size();
            size_t rnd3 = rng() % namesSurRf.size();
            size_t rnd4 = rng() % namesSurRl.size();
            return namesFemRf[rnd] + namesFemRl[rnd2] + " " + namesSurRf[rnd3] + namesSurRl[rnd4];
        } else if (i < 8) {
            size_t rnd = rng() % namesFemFf.size();
            size_t rnd2 = rng() % namesFemFl.size();
            size_t rnd3 = rng() % namesSurFf.size();
            size_t rnd4 = rng() % namesSurFl.size();
            return namesFemFf[rnd] + namesFemFl[rnd2] + " " + namesSurFf[rnd3] + namesSurFl[rnd4];
        } else {
            size_t rnd = rng() % namesFem.size();
            size_t rnd3 = rng() % namesSur.size();
            return namesFem[rnd] + " " + namesSur[rnd3];
        }
    } else { // male / default variant
        if (i < 4) {
            size_t rnd = rng() % namesMaleRf.size();
            size_t rnd2 = rng() % namesMaleRl.size();
            size_t rnd3 = rng() % namesSurRf.size();
            size_t rnd4 = rng() % namesSurRl.size();
            return namesMaleRf[rnd] + namesMaleRl[rnd2] + " " + namesSurRf[rnd3] + namesSurRl[rnd4];
        } else if (i < 8) {
            size_t rnd = rng() % namesMaleFf.size();
            size_t rnd2 = rng() % namesMaleFl.size();
            size_t rnd3 = rng() % namesSurFf.size();
            size_t rnd4 = rng() % namesSurFl.size();
            return namesMaleFf[rnd] + namesMaleFl[rnd2] + " " + namesSurFf[rnd3] + namesSurFl[rnd4];
        } else {
            size_t rnd = rng() % namesMale.size();
            size_t rnd2 = rng() % namesSur.size();
            return namesMale[rnd] + " " + namesSur[rnd2];
        }
    }
}
