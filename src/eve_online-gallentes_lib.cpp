...
std::string generate_eve_online_gallentes_name(std::mt19937& rng, int type) {
    // Choose random indices
    auto randIdx = [&](size_t max) -> size_t { return rng() % max; };

    if (type == 1) {
        const std::string& part1 = names5[randIdx(names5.size())];
        const std::string& part2 = names6[randIdx(names6.size())];
        const std::string& part3 = names3[randIdx(names3.size())];
        const std::string& part4 = names4[randIdx(names4.size())];
        return part1 + part2 + " " + part3 + part4;
    } else {
        const std::string& part1 = names1[randIdx(names1.size())];
        const std::string& part2 = names2[randIdx(names2.size())];
        const std::string& part3 = names3[randIdx(names3.size())];
        const std::string& part4 = names4[randIdx(names4.size())];
        return part1 + part2 + " " + part3 + part4;
    }
